...
O \stwopa foi modificado então para publicar cada \sensordata no \eventbus, e o \qocevaluator registra interesse em receber objetos do tipo \sensordata publicados no \eventbus.
