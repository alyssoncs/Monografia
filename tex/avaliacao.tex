...
Para este experimento foi feita uma simulação de um indivíduo andando em uma residência,\marginpar{ponto} foram utilizados os dados do \dataset descrito na \autoref{chap:avaliacao-simulacao-beacons} para esta simulação.
...
\begin{table}[htb]
	\begin{center}
		\IBGEtab{
			\caption{Performance da entrega de mensagens}
